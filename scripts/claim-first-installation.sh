...
{ cat <<'SQL'
begin;select pg_advisory_xact_lock(1937002751);select set_config('steam_top.expected_platform_migration_sha','1135865894cd73de9c69649958fcaab0f663b64a4c97ae4d3b1c5d81e12f6e68',true);select set_config('steam_top.expected_protect_function_sha',:'protect_sha',true),set_config('steam_top.expected_deletion_function_sha',:'deletion_sha',true),set_config('steam_top.expected_pristine_function_sha',:'pristine_sha',true);
SQL
cat "$catalog_sql"
cat <<'SQL'
