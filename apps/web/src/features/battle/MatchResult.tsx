...
export function MatchResult({ result, cancelledReason }: Readonly<{ result?: MatchResultView | undefined; cancelledReason?: "attempt-limit" | "server-error" | "admin-removed" | undefined }>) {
