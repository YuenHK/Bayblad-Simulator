...
export type ArenaFrame = Readonly<{ sequence: number; tick: number; presentation?: { startsAtMs: number; durationMs: 30000 | 60000; elapsedMs: number; zodiacIndex: number; skillName: string; finisher?: "player1" | "player2" | "draw" | undefined } | undefined; player1: Readonly<{ x: number; y: number; angle: number; angularSpeed: number }>; player2: Readonly<{ x: number; y: number; angle: number; angularSpeed: number }> }>;
