...
export async function startProductionServer(
  ...
  await checkDatabaseReadiness(client.sql);
  ...
  registerHealthRoutes(app, async () => { if (!readinessHealthy) throw new Error("FAIL_STOP_READINESS_LOST"); return checkDatabaseReadiness(client.sql); });
